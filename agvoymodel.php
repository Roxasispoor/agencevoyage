...
function get_all_circuits()
{
    ...
    foreach($returned_circuits as $c) {
    	...
    	//$returned_programmations= $app['db']->fetchAll("Select * FROM programmations")
...
function get_programmations_by_circuit_id($id)
{
    ...
    $returned_programmations = $app['db']->fetchAll("SELECT * FROM programmation_circuit WHERE circuit_id == $id");

    foreach($returned_programmations as $c) {

        $programmation = new ProgrammationCircuit($c['date_depart'],$c['nombre_personnes'], $c['prix'], $id);
        
        $programmation->setDateDepart($c['date_depart']);
        $programmation->setNombrePersonnes($c['nombre_personnes']);
        $programmation->setPrix($c['prix']);
